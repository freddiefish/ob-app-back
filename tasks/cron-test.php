...
require_once('BarPageBuilder.php');
/**
 * @var string $book 
 */
$tomSawyerBook = file_get_contents('text.txt');
$huckFinnBook = file_get_contents('test2.txt');
/**
...
file_put_contents("example_02_document_collections.html", $html);
